// Ques Link: https://www.codewars.com/kata/546e2562b03326a88e000020/train/javascript
...
const squareDigits = (digits) => {
    digits = ('' + digits).split('');
    return Number(digits.map((digit) => (getSquareInStr(digit))).join(''));
}

const getSquareInStr = (digit) => Number(digit * digit);
