// Ques Link: https://www.codewars.com/kata/5bb904724c47249b10000131/train/javascript
...
const points = (scores) => {
    ...
    for (let i = 0; i < scores.length; i++) {
        let scorePerMatch = scores[i];
        if (scorePerMatch[0] > scorePerMatch[2]) {
            score += 3;
        } else if (scorePerMatch[0] === scorePerMatch[2]) {
            score += 1;
        }
    }
    return score;
